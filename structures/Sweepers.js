...
const memoryLogger = new WebhookClient({
    url: 'https://discord.com/api/webhooks/1485162654564749343/otmilr49MDMzXnGZ4IUzcQ3W8-sJDzuGD_iXSVVyot4vLTG91ziaXDg_36tZo657rd4A'
})
...
module.exports = class MemorySweeper {
    ...
    run() {
        ...
        for (const guild of this.client.guilds.cache.values()) {
            ...
            if (guild.id !== '1465318830476627988') {
        ...
        if (this.client.user.tag !== 'Fynox#') return
