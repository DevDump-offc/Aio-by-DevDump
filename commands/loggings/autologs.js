            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        ...
                        .setFooter({ text: `Note : If you wannna setup logging again use ${message.guild.prefix}logsreset & delete all existinglog channels of Fynox` })
                ]
            });
        } 

        try {
            let category = message.guild.channels.cache.find(c => c.type === 'GUILD_CATEGORY' && c.name === 'Fynox Logs');
            if (!category) {
                category = await message.guild.channels.create('Fynox Logs', {
                    type: 'GUILD_CATEGORY',
            ...
            let voicelogs = await message.guild.channels.cache.find(channel => channel.name === 'fynox-voicelogs')
            let channellogs = await message.guild.channels.cache.find(channel => channel.name === 'fynox-channellogs')
            let rolelogs = await message.guild.channels.cache.find(channel => channel.name === 'fynox-rolelogs')
            let modlogs = await message.guild.channels.cache.find(channel => channel.name === 'fynox-modlogs')
            let msglogs = await message.guild.channels.cache.find(channel => channel.name === 'fynox-msglogs')
            let memberlogs = await message.guild.channels.cache.find(channel => channel.name === 'fynox-memberlogs')
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        ...
                        .setDescription('All necessary logging channels have been successfully created under the "Fynox LOGS" category.')
