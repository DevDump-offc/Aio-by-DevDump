    ...
    run: async (client, message, args) => {
        ...
        try {
            ...
            if (option === 'enable') {
                ...
                let description = '- By clicking Accept you agree to our terms and conditions.\n - Disable Onboarding\n - Disable Rules\n- After antivanity enable successfully you can enable all the thing above listed above\n\n**NOTE -**Fynox will grant an external Discord account special permissions in your server to safeguard your vanity URL. If anyone tries to change your vanity URL, this account will automatically restore it to the original, ensuring it remains protected from theft.';
