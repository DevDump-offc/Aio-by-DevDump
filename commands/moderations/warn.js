    ...
    run: async (client, message, args) => {
        ...
        const embed = new MessageEmbed()
            ...
            .setDescription(`
             Target User: <@${user.id}>
             DM Sent: Yes
             **Warned By**: [${message.member.displayName}](https://discord.com/users/${message.author.id})
             Reason: ${reason || 'None'}
            `)
            .setColor(client.color)
            ...
            try {
                ...
                .setColor(client.color)
                .setDescription(` You have been warned in **${message.guild.name}** Warned By: [${message.member.displayName}](https://discord.com/users/${message.author.id})\n **Reason:** ${reason}`)
