...
async function enableAutomod(client, message) {
    try {
        ...
        const alertChannel = await message.guild.channels.create('Fynox - Automod Alerts', {
            type: 'GUILD_TEXT',
                ...
                actions: [
                    {
                        ...
                        metadata: {
                            ...
                            durationSeconds: 10,
                            customMessage: 'This message has been blocked by Fynox.'
                        }
                    },
                    {
                        type: 2,
