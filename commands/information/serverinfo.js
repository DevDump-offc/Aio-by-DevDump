    ...
    run: async (client, message, args) => {
        ...
        const embed = new MessageEmbed()
            ...
            .addFields([
                {
                    name: '__About__',
                    value: `> **Name**: ${guild.name} \n > **ID**: ${guild.id} \n > ** Owner :** <@!${ownerId}> (${ownerId})\n > **Server Created at:** <t:${parseInt(createdTimestamp / 1000)}:R>\n > **Members: **${guild.memberCount}\n > **Banned Members: **${bans}`
                },
                {
                ...
                {
                    name: '__Channels__',
                    value: `> ** Text: ** ${channels.filter((channel) => channel.type === 'GUILD_TEXT').size}\n > ** Voice:** ${channels.filter((channel) => channel.type === 'GUILD_VOICE').size}\n > **Total: ** ${channels.size}\n`
                },
                {
                    name: '__Emoji Info__',
